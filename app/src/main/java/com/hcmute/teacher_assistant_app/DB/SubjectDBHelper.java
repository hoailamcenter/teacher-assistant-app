...
public class SubjectDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE = String.format("CREATE TABLE %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT, %s INTEGER, %s TEXT , %s INTEGER  )",
    ...
    public void createDefaultSubject() {
        Subject subject1 = new Subject(0, "Toan", 1, 2, "2022-2023");
        Subject subject2 = new Subject(0, "Van", 1, 2, "2022-2023");
        Subject subject3 = new Subject(0, "Anh", 1, 2, "2022-2023");
