...
public class TeacherDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE = String.format("CREATE TABLE %s ( " + "%s INTEGER PRIMARY KEY, " + "%s TEXT, " + "%s TEXT)", TABLE_NAME, COLUMN_ID, COLUMN_NAME, COLUMN_PASSWORD);
    ...
    public void createDefaultTeachersIfNeed() {
        ...
        if (count == 0) {
            Teacher Teacher1 = new Teacher(1, "Truong Thi Ngoc Phuong", "123456");
            Teacher Teacher2 = new Teacher(2, "Nguyen Tran Thi Van", "123456");
            Teacher Teacher3 = new Teacher(3, "Nguyen Thien Bao", "123456");
    ...
    public Teacher getTeacher(int id) {
        ...
        Cursor cursor = db.query(TABLE_NAME, new String[]{COLUMN_ID, COLUMN_NAME, COLUMN_PASSWORD}, COLUMN_ID + "=?", new String[]{String.valueOf(id)}, null, null, null, null);
    ...
    public void deleteTeacher(Teacher Teacher) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_NAME, COLUMN_ID + " = ?", new String[]{String.valueOf(Teacher.getId())});
        db.close();
    }
