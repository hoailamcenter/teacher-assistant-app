...
public class EventDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase litedb) {
        String CREATE_TABLE = String.format("CREATE TABLE %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT, %s TEXT, %s TEXT , %s TEXT , %s TEXT  )", TABLE_NAME, COLUMN_idEvent, COLUMN_nameEvent, COLUMN_startTime, COLUMN_endTime, COLUMN_day, COLUMN_place);
    ...
    public void createDefaultEvent() {
        ...
        Event event3 = new Event(0, "Va lung tung 14-2", "00:00", "24:00", "14/02/2023", "Phòng học 305");
