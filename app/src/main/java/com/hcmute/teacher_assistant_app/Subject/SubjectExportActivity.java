...
public class SubjectExportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(SubjectExportActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);
...
//                openPDFfile("DanhSachSinhVien.pdf");
    ...
    public void createPdfWithItext7(View v) {
        ...
        try {
            ...
            for (int i = 0; i < 2; i++) {
                Cell[] headerFooter = new Cell[]{new Cell().setBackgroundColor(color).setTextAlignment(TextAlignment.CENTER).add(column1), new Cell().setBackgroundColor(color).setTextAlignment(TextAlignment.CENTER).add(column2), new Cell().setBackgroundColor(color).setTextAlignment(TextAlignment.CENTER).add(column3), new Cell().setBackgroundColor(color).setTextAlignment(TextAlignment.CENTER).add(column4), new Cell().setBackgroundColor(color).setTextAlignment(TextAlignment.CENTER).add(column5)};
